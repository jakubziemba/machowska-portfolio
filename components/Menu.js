      ...
      <ul>
        ...
        <div className={aboutActive && styles.active}>
          <p className={styles.text}>
            ...
            design and installation. Her work for the bachelor’s
            thesis in Fine Arts was a series of graphics “Tamed
            element”. She took part in some group shows and held her
            solo exhibitions as well; including one at the Władysław
            Hasior Gallery in Zakopane (branch of the Tatra Museum),
            or at the Capital Centre for Cultural Education in Warsaw.
            In her works she is inspired by nature and abstraction
            forms.
          </p>
        </div>
